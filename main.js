...
function lineontext(){
    ...
    var sum=row.rowIndex;
    if(this.checked){
        
        row.style.textDecoration='line-through';
        row.style.backgroundColor='rgb(84, 171, 177)';
        row.style.transition='0.5s';
        document.getElementsByClassName('editicon')[sum-1].style.display="none";
    }
    else{
        row.style.textDecoration='none';
        row.style.backgroundColor='white';
        document.getElementsByClassName('editicon')[sum-1].style.display="inline";
    }
}
